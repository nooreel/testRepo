	       ...
	       /* os설치 현황 */
			...
			/* 현장 sw 배포 현황*/
				   ...
				   var barOptions = {
				       ...
				       var data = [
				            {label: "PASS", data:data1, bars: {fillColor: "#4F86C0",order:1}, color: "#336600"},
				            {label: "FAIL", data:data2, bars: {fillColor: "#FC9B2B",order:2}, color: "#E41B17"}
				        ];
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="panel panel-default">
				<div class="panel-heading">OS 설치 현황</div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					<div class="flot-chart">
						<div class="flot-chart-content" id="flot-pie-chartsemi"></div>
					</div>
				</div>
				<!-- /.panel-body -->
			</div>
		...
		<div class="col-lg-6">
			<div class="panel panel-default">
				...
				<!-- /.panel-heading -->
				<div class="panel-body">
					<div id="flotbarchart" style="height:400px;"></div>
				</div>
				<!-- /.panel-body -->
			</div>
			<!-- /.panel -->
		...
		<div class="col-lg-6">
			<div class="panel panel-default">
				<div class="panel-heading">현장 sw 배포 현황</div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					<div id="standardsw" style="height:400px;"></div>
				</div>
				<!-- /.panel-body -->
			</div>
			<!-- /.panel -->
