...
public class CommercialSwPaging {
	...
	public CommercialSwPaging() {
	}

	public CommercialSwPaging(String textpageNumber,int totalCount,String url, String swDate) {
	...
	private String getPagingHtml( String url ){ //페이지를 문자열로 만든다.
		...
		//토탈 페이지
		String f3=" &nbsp&nbsp of &nbsp&nbsp "+this.getTotalPage();
