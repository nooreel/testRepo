...
public class NClientInfoByAreaPaging {
	...
	public NClientInfoByAreaPaging() {
	}

	public NClientInfoByAreaPaging(String textpageNumber,int totalCount,String url, String swDate,String swname) {
