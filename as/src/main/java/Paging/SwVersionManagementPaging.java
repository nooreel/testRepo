...
public class SwVersionManagementPaging {
   ...
   public SwVersionManagementPaging() {
   }

   public SwVersionManagementPaging(String textpageNumber,int totalCount,String url, String swDate) {
