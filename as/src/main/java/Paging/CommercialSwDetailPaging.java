...
public class CommercialSwDetailPaging {
	...
	public CommercialSwDetailPaging() {
	}

	public CommercialSwDetailPaging(String textpageNumber,int totalCount,String url, String swDate,String swname) {
