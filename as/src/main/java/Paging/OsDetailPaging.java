...
public class OsDetailPaging {
	...
	public OsDetailPaging() {
	}

	public OsDetailPaging(String textpageNumber,int totalCount,String url, String swDate,String swnumber) {
	...
	private String getPagingHtml( String url ){ //페이지를 문자열로 만든다.
		...
		//<< 버튼 (1페이지로 가기)
		String f1="<a href='"+this.getUrl()+"?pageNumber=1&swDate="+this.swDate+"&swnumber="+this.swnumber+"'>"+
				"<i class='fa fa-angle-double-left'></i>&nbsp&nbsp"+"</a>";
		
		//< 버튼 (페이지 -1)
		String f6="<a href='"+this.getUrl()+"?pageNumber="+beforepage+"&swDate="+this.swDate+"&swnumber="+this.swnumber+"'>"
		...
		//>> 버튼 (마지막 페이지)
		String f4="<a href='"+this.getUrl()+"?pageNumber="+this.getEndPage()+"&swDate="+this.swDate+"&swnumber="+this.swnumber+"'>"+
		"&nbsp&nbsp<i class='fa fa-angle-double-right'></i></a>";
		
		// > 버튼 (페이지 +1)
		String f7="<a href='"+this.getUrl()+"?pageNumber="+nextpage+"&swDate="+this.swDate+"&swnumber="+this.swnumber+"'>"
				+"&nbsp&nbsp<i class='fa fa-angle-right'></i></a>";
		
		//히든데이터(swDate)
		String f10="<input type='hidden' name='swDate' value='"+this.swDate+"'>";
		String f11="<input type='hieend' name='swnumber' value='"+this.swnumber+">";
		
		String f5="</form>";
		result=f0+f1+f6+f2+f3+f7+f4+f10+f11+f5;
