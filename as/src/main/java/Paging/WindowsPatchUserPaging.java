...
public class WindowsPatchUserPaging {
	...
	public WindowsPatchUserPaging() {
	}

	public WindowsPatchUserPaging(String textpageNumber,int totalCount,String url, String swDate,String swname) {
